...
class CloudHttpTransport {
            ...
            Dio(
              BaseOptions(
                ...
                headers: const {
                  ...
                  'User-Agent': 'LifeTrace-Assets-Flutter',
                },
              ),
            );
  ...
  Future<Map<String, dynamic>> requestJson({
    ...
    try {
      ...
      throw const FormatException('LifeTrace Cloud returned a non-object JSON response');
      ...
      throw CloudApiException(
        ...
        retryable:
            json['retryable'] == true || statusCode == 429 || statusCode >= 500,
