...
## Purpose
Defines the local-first persistence contract for Assets across supported platforms, including durable mutations, recoverable failures, backup/restore, and sensitive-field handling.
