...
## Purpose
Defines observable analytics behavior derived from persisted asset and lifecycle data, including safe empty values, valuation totals, retention, and monthly activity.
